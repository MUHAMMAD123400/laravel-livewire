                                        ...
                                        <article class="blog-post">
                                            ...
                                            <div class="pt-4">
                                                <p class="mb-3">
                                                    ...
                                                    {{ isset($article->created_at) ? \Carbon\Carbon::parse($article->created_at)->format('d M, Y') : '' }}
                                                </p>
                                                <h2 class="h4"><a class="text-black" wire:navigate
                                                        href="{{ route('blogDetail', $article->id) }}">{{ $article->title }}</a>
                                                </h2>
                        ...
                        <ul class="list-unstyled widget-list">
                            @if ($categories->isNotEmpty())
                                ...
                                @foreach ($categories as $category)
                                    <li><a wire:navigate
                                            href="{{ route('blog') . '?categorySlug=' . $category->slug }}">{{ $category->name }}</a>
                                    </li>
                                @endforeach
                                ...
                                <ul class="list-unstyled widget-list">
                                    <li class="d-flex widget-post align-items-center">
                                        <a class="text-black" wire:navigate
                                            href="{{ route('blogDetail', $latestArticle->id) }}">
                                        ...
                                        <div class="flex-grow-1">
                                            <h5 class="h6 mb-0"><a class="text-black" wire:navigate
                                                    href="{{ route('blogDetail', $latestArticle->id) }}">{{ $latestArticle->title }}</a>
                                            </h5>
